            ...
            // }else{
                ...
                if( (get_option('page_suggestion_enabled') == '1') && count($relevant_pagelink) > 0 ){
                    ...
                    if(is_array($relevant_post_link )){
                        ...
                        $relevant_pagelinks = '<br><br><p><em>'. implode('', $relevant_post_link) .'</em><p>'. implode("</br>", $relevant_pagelink);
                   }else{
                    $relevant_pagelinks = '<br><br><p><em>'. $relevant_post_link .'</em><p>'. implode("</br>", $relevant_pagelink);
                   }
                }else{
                    $relevant_pagelinks = '';
                }
